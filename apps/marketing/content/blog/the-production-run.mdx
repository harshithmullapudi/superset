...
That first row is real. One person out of 320 ranked developers on the board today is above the bottom tier, and we're publishing it rather than quietly recalibrating until the chart looks better.
